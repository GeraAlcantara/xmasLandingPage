...
function Hero() {
  return (
    <div className='bg-gradient-to-b from-brandPurple-700 to-brandPurple-600 py-4 md:py-16 min-h-[calc(100vh-56px)]  flex flex-col justify-around '>
      <div className='container m-auto px-4 md:px-8 xl:px-0 text-white flex flex-col-reverse lg:flex-row lg:items-center lg:justify-between'>
        ...
        <div className='hidden lg:absolute -bottom-14 lg:bottom-4 right-8 lg:flex flex-col gap-4'>
          <ToastNotification />
